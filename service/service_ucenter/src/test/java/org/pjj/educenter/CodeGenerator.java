...
//        gc.setOutputDir(projectPath + "/src/main/java");//输出目录 (代码生成在哪个目录)
        gc.setOutputDir("E:/IDEA/setoutProject/guli-website-master/guli_parent/service/service_ucenter/src/main/java");// 建议使用绝对路径
        gc.setAuthor("pjj");
        ...
        pc.setModuleName("educenter"); //模块名  org.pjj.eduservice
