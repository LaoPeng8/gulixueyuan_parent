...
//        gc.setOutputDir(projectPath + "/src/main/java");//输出目录 (代码生成在哪个目录)
        gc.setOutputDir("E:/IDEA/setoutProject/guli-website-master/guli_parent/service/service_order/src/main/java");// 建议使用绝对路径
        ...
        pc.setModuleName("order"); //模块名  org.pjj.comment
